---
name: risk-profiles
description: Maps a change type to the verification it needs - tests, behavior inventory, closed-area review, code-review effort. Consult when designing a change (/flow:spec), accepting one (/flow:accept), or whenever deciding how much testing or review a change requires.
...
| Profile | Applies to | Mandatory verification | Behavior inventory | closed-area review | /code-review effort |
|---|---|---|---|---|---|
